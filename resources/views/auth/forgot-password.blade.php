...
<head>
  ...
  <title>IFMMS — Forgot Password</title>
...
<body class="min-h-screen login-bg flex items-center justify-center p-4">
  <div class="w-full max-w-md px-8 py-12 glass-effect rounded-3xl shadow-2xl fade-in">
    <div class="text-center mb-10">
      ...
      <h1 class="text-3xl font-bold text-gray-800 logo-glow mb-3">Forgot Password</h1>
      <p class="text-sm text-gray-600 font-medium">Enter your email to reset your password</p>
